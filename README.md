...
> Automated workflow executing security scans and evaluating responses against prompt injection payloads.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/agentic-rag-security-lab/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-agentic-rag-security-lab.git
cd tp-agentic-rag-security-lab
```
...
```bash
kubectl port-forward deployment/tp-agentic-rag-security-lab 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── security_lab.py     # Main configuration file
```
...
---
*Generated by [Agentic RAG Security Lab Studio](https://pradeeptalari14.github.io/portfolio/tools/agentic-rag-security-lab/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
